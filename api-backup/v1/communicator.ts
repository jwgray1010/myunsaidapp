...
const observeRequestSchema = z.object({
  ...
  // Client sends current learning signals state
  currentLearningSignals: z.object({
    anxious: z.number().default(0),
    avoidant: z.number().default(0),
    disorganized: z.number().default(0),
    secure: z.number().default(0),
    totalCommunications: z.number().default(0),
    daysObserved: z.number().default(0),
    windowComplete: z.boolean().default(false)
  }).optional()
});
